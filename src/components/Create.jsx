...
const Create= () => {
  ...
  return (
    <div className='modal-wrap w-screen h-screen '
      ...
      <div className=" bg-[#eef1f7] rounded-xl modal-inner-wrap   ">
        <form className="flex flex-col ">
          <div className="flex flex-row justify-between items-center">
            <p className="font-semibold text-black">Mint NFT</p>
            
          </div>

          <div className="flex flex-row justify-center items-center rounded-xl mt-5">
            <div className="shrink-0 rounded-xl overflow-hidden h-20 w-55">
              <img
                alt="NFT"
          ...
          <button
            ...
            className="flex flex-row justify-center items-center
              ...
              hover:bg-[#8359ff] py-2 px-5 rounded-full
